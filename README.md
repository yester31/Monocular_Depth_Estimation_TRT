...
| `unidepth_v2`       | fp16      | 11.47   | 11.45 | 87.18  | point map + intrinsics       |
| `unik3d`            | fp16      | 14.56   | 14.56 | 68.69  | point map + intrinsics       |
| `depth_anything_v3` | fp16      | 19.49   | 19.48 | 51.32  | relative + sky mask          |
| `vggt`              | fp16      | 52.22   | 52.22 | 19.15  | geometry (scale unknown)     |
| `streamvggt`        | fp16      | 52.71   | 52.69 | 18.97  | geometry (scale unknown)     |
...
| `metric_anything` | fp16      | 68.03   | 68.01 | 14.70 | point map + metric_scale |
