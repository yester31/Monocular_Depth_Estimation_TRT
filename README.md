...
| --- | --- | ---: | ---: | ---: | --- |
| `depth_anything_v2` | fp16      | 4.30    | 4.27  | 232.77 | metric (hypersim) by default |
| `depth_anything_ac` | fp16      | 4.36    | 4.37  | 229.29 | relative                     |
| `distill_any_depth` | fp16      | 4.42    | 4.30  | 226.48 | relative                     |
| `unidepth_v2`       | fp16      | 8.25    | 8.19  | 121.25 | point map + intrinsics       |
| `unik3d`            | fp16      | 8.44    | 8.43  | 118.42 | point map + intrinsics       |
| `depth_anything_v3` | fp16      | 19.60   | 19.59 | 51.02  | metric + sky mask            |
| `vggt`              | fp16      | 52.76   | 52.76 | 18.95  | geometry (scale unknown)     |
| `streamvggt`        | fp16      | 53.39   | 53.38 | 18.73  | geometry (scale unknown)     |

**Input 388x518**

| model             | precision | mean ms | p50   | fps   | output                   |
| --- | --- | ---: | ---: | ---: | --- |
| `moge_2`          | fp16      | 19.65   | 19.65 | 50.90 | point map + metric_scale |
| `metric_anything` | fp16      | 67.21   | 67.21 | 14.88 | point map + metric_scale |

**Input 1536x1536**  (only model at this size)

| model       | precision | mean ms | p50    | fps  | output |
| --- | --- | ---: | ---: | ---: | --- |
| `depth_pro` | fp16      | 241.28  | 241.13 | 4.14 | metric |

**Input 616x1064**  (only model at this size)

| model         | precision | mean ms | p50   | fps   | output                       |
| --- | --- | ---: | ---: | ---: | --- |
| `metric3d_v2` | fp32      | 61.79   | 61.79 | 16.18 | canonical (not metres - D12) |
