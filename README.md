...
| --- | --- | ---: | ---: | ---: | --- |
| `depth_anything_v2` | fp16      | 4.31    | 4.24  | 231.93 | metric (hypersim) by default |
| `distill_any_depth` | fp16      | 4.31    | 4.22  | 231.83 | relative                     |
| `unidepth_v2`       | fp16      | 9.86    | 9.83  | 101.41 | point map + intrinsics       |
| `depth_anything_ac` | fp16      | 10.09   | 10.09 | 99.11  | relative                     |
| `unik3d`            | fp16      | 16.01   | 15.99 | 62.47  | point map + intrinsics       |
| `depth_anything_v3` | fp16      | 19.38   | 19.39 | 51.61  | metric + sky mask            |
...
| model         | precision | mean ms | p50   | fps   | output                       |
| --- | --- | ---: | ---: | ---: | --- |
| `metric3d_v2` | fp32      | 60.54   | 60.55 | 16.52 | canonical (not metres - D12) |
