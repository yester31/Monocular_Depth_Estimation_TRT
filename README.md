...
| `unidepth_v2`       | fp16      | 8.16    | 8.15  | 122.61 | point map + intrinsics       |
| `unik3d`            | fp16      | 8.37    | 8.37  | 119.47 | point map + intrinsics       |
| `depth_anything_v3` | fp16      | 19.90   | 19.89 | 50.26  | metric + sky mask            |
| `vggt`              | fp16      | 52.58   | 52.58 | 19.02  | geometry (scale unknown)     |
| `streamvggt`        | fp16      | 53.34   | 53.33 | 18.75  | geometry (scale unknown)     |
