...
| --- | --- | ---: | ---: | ---: | --- |
| `distill_any_depth` | fp16      | 4.26    | 4.17  | 234.95 | relative                     |
| `depth_anything_v2` | fp16      | 4.30    | 4.27  | 232.30 | metric (hypersim) by default |
| `unidepth_v2`       | fp16      | 9.76    | 9.75  | 102.43 | point map + intrinsics       |
| `depth_anything_ac` | fp16      | 10.03   | 10.02 | 99.71  | relative                     |
| `unik3d`            | fp16      | 15.90   | 15.90 | 62.87  | point map + intrinsics       |
| `depth_anything_v3` | fp16      | 19.47   | 19.44 | 51.36  | metric + sky mask            |
| `streamvggt`        | fp16      | 52.75   | 52.77 | 18.96  | geometry (scale unknown)     |
| `vggt`              | fp16      | 52.82   | 52.82 | 18.93  | geometry (scale unknown)     |

**Input 388x518**

| model             | precision | mean ms | p50   | fps   | output                   |
| --- | --- | ---: | ---: | ---: | --- |
| `moge_2`          | fp16      | 29.63   | 29.60 | 33.75 | point map + metric_scale |
| `metric_anything` | fp16      | 68.60   | 68.61 | 14.58 | point map + metric_scale |

**Input 1536x1536**  (only model at this size)

| model       | precision | mean ms | p50    | fps  | output |
| --- | --- | ---: | ---: | ---: | --- |
| `depth_pro` | fp16      | 240.66  | 240.69 | 4.16 | metric |

**Input 616x1064**  (only model at this size)

| model         | precision | mean ms | p50   | fps   | output                       |
| --- | --- | ---: | ---: | ---: | --- |
| `metric3d_v2` | fp32      | 60.76   | 60.78 | 16.46 | canonical (not metres - D12) |
