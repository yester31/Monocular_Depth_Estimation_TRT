...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| WARN | `depth_anything_v3` | fp16 | 1   | -          | 7.8430% | 0.012    | 0.997905 | 1.0037 |
| ok   | `unik3d`            | fp16 | 1   | -          | 0.9241% | 0.0109   | 0.999754 | 1.0026 |
| ok   | `metric3d_v2`       | fp32 | 0   | -          | 0.6219% | 35.9     | 0.999608 | 0.9972 |
| ok   | `unik3d`            | fp16 | 0   | -          | 0.3260% | 0.136    | 0.999997 | 0.9968 |
| ok   | `metric_anything`   | fp16 | 2   | -          | 0.3174% | 0.00398  | -        | 0.9968 |
| ok   | `depth_pro`         | fp16 | 0   | -          | 0.2030% | 0.0122   | 0.999994 | 0.9983 |
| ok   | `moge_2`            | fp16 | 1   | -          | 0.1624% | 0.0119   | 0.999997 | 1.0000 |
| ok   | `depth_anything_v2` | fp16 | 0   | -          | 0.1201% | 0.0218   | 0.999980 | 0.9998 |
| ok   | `depth_anything_v3` | fp16 | 0   | -          | 0.1125% | 0.0323   | 0.999997 | 0.9991 |
| ok   | `distill_any_depth` | fp16 | 0   | -          | 0.0950% | 0.0946   | 0.999996 | 1.0004 |
| ok   | `depth_anything_ac` | fp16 | 0   | -          | 0.0843% | 0.0568   | 0.999997 | 1.0003 |
| ok   | `moge_2`            | fp16 | 3   | -          | 0.0632% | 0.000722 | -        | 1.0006 |
| ok   | `metric_anything`   | fp16 | 0   | -          | 0.0514% | 0.0259   | 1.000000 | 0.9998 |
| ok   | `moge_2`            | fp16 | 0   | -          | 0.0389% | 0.00698  | 1.000000 | 1.0000 |
| ok   | `depth_pro`         | fp16 | 1   | -          | 0.0161% | 0.00779  | -        | 1.0002 |
| ok   | `metric_anything`   | fp16 | 1   | -          | 0.0000% | 1.36e-05 | 0.999198 | 1.0000 |
| ok   | `moge_2`            | fp16 | 2   | -          | 0.0000% | 0.000282 | 0.999983 | 1.0000 |
