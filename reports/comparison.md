...
| `distill_any_depth` | single  | -       | fp16      | 10.02   | 10.01 | 10.08 | 99.80  | relative                     |
| `streamvggt`        | single  | -       | fp16      | 53.19   | 53.17 | 53.38 | 18.80  | geometry (scale unknown)     |
| `unidepth_v2`       | single  | -       | fp16      | 11.60   | 11.61 | 11.69 | 86.17  | point map + intrinsics       |
| `unik3d`            | single  | -       | fp16      | 14.47   | 14.48 | 14.55 | 69.09  | point map + intrinsics       |
...
| model         | variant | encoder | precision | mean ms | p50    | p90    | fps  | output                       |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `metric3d_v2` | single  | -       | fp32      | 349.81  | 350.05 | 351.34 | 2.86 | canonical (not metres - D12) |
