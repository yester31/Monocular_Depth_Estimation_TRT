...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `depth_anything_ac` | single  | vits            | fp16      | 4.36    | 4.37  | 4.39  | 229.29 | relative                     |
| `depth_anything_v2` | single  | -               | fp16      | 4.30    | 4.27  | 4.32  | 232.77 | metric (hypersim) by default |
| `depth_anything_v3` | single  | DA3Metric-Large | fp16      | 19.60   | 19.59 | 19.65 | 51.02  | metric + sky mask            |
| `distill_any_depth` | single  | small           | fp16      | 4.42    | 4.30  | 4.92  | 226.48 | relative                     |
| `streamvggt`        | single  | fixed           | fp16      | 53.39   | 53.38 | 53.47 | 18.73  | geometry (scale unknown)     |
| `unidepth_v2`       | single  | vits            | fp16      | 8.25    | 8.19  | 8.29  | 121.25 | point map + intrinsics       |
| `unik3d`            | single  | vits            | fp16      | 8.44    | 8.43  | 8.51  | 118.42 | point map + intrinsics       |
| `vggt`              | single  | fixed           | fp16      | 52.76   | 52.76 | 52.86 | 18.95  | geometry (scale unknown)     |
...
| model             | variant | encoder | precision | mean ms | p50   | p90   | fps   | output                   |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `metric_anything` | single  | fixed   | fp16      | 67.21   | 67.21 | 67.43 | 14.88 | point map + metric_scale |
| `moge_2`          | single  | vits    | fp16      | 19.65   | 19.65 | 19.69 | 50.90 | point map + metric_scale |
...
| model       | variant | encoder | precision | mean ms | p50    | p90    | fps  | output |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `depth_pro` | single  | fixed   | fp16      | 241.28  | 241.13 | 242.69 | 4.14 | metric |
...
| model         | variant | encoder | precision | mean ms | p50   | p90   | fps   | output                       |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `metric3d_v2` | single  | vits    | fp32      | 61.79   | 61.79 | 61.99 | 16.18 | canonical (not metres - D12) |
