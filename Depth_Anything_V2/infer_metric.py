...
def set_model(encoder='vits', dataset = 'hypersim', input_size=518, dtype: torch.dtype = torch.float32):
    # Model Config
    model_configs = {
...
def main():
    ...
    output_file_depth = os.path.join(save_dir_path, os.path.splitext(image_file_name)[0] + f'_{dataset}_torch.jpg')
    cv2.imwrite(output_file_depth, color_depth_bgr)

    # save_npz
    output_file_npz = os.path.join(save_dir_path, os.path.splitext(image_file_name)[0]+ f'_{dataset}_torch')
