...
The benchmark and generated engine use the smallest released configuration,
`small`. The download section lists all three checkpoint sizes.

## TensorRT Performance

<!-- BENCH:BEGIN -->
- Input **518x518**, precision **fp16**, 100 iterations after 20 warmup
- **4.32 ms** mean, p50 4.32 / p90 4.35 / p99 4.49, min 4.26
- **231.47 fps**
