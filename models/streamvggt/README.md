...
| Output | Depth with unknown global scale |
| Scale | Unknown; do not interpret values as metres |
| TensorRT target | Fixed upstream model, FP16 |

## Supported Encoders

StreamVGGT is exported as one fixed upstream configuration in this
...
- **52.83 ms** mean, p50 52.82 / p90 52.90 / p99 52.98, min 52.66
- **18.93 fps**
