...
# preprocess_image() is now core/preprocess.py: stretch to the engine's size,
# /255 in float64, ImageNet statistics in float64, cast to float32. Byte-identical
# to what stood here -- tests/test_preprocess.py asserts np.array_equal against
# reports/inputs/depth_anything_v3.npy.
...
def main():
    ...
    batch_images, geom = pp.preprocess_for(raw_img, 'depth_anything_v3',
                                           (input_h, input_w))
