...
# Re-exported so callers that already say `prof.save(...)` keep working. The
# implementations live in profile_store because they are plain file I/O and
# this module cannot be imported without TensorRT.
from core.profile_store import REPORTS, load_saved, save  # noqa: E402,F401
