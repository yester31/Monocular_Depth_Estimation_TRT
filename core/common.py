...
#
# This file moved into core/, so the root is now two levels up. The append
# stays: `from core...` below needs the root importable, and a caller that
# reached this module by some other route may not have put it there.
