"""Does moving preprocessing into the engine pay for itself?
    ...
    python ab_input_dtype.py depth_anything_v2
    python ab_input_dtype.py --all
    python ab_input_dtype.py depth_pro --iterations 200
...
from package_artifacts import onnx_beside  # noqa: E402
...
def run_engine(engine_path, feed, iterations, warmup):
    ...
    from common_runtime import StageTimer
