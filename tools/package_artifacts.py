"""Assemble artifacts/<model>/<profile>-<precision>/ for the built engines.
    ...
    python tools/package_artifacts.py                # every model with a record
    python tools/package_artifacts.py unik3d vggt
    python tools/package_artifacts.py --no-copy      # manifests only, no engine copy
    python tools/package_artifacts.py --verify       # check what is already there
